...
write_dta(nhanes1999_2000 %>% select(seqn,riagendr,ridageyr,asbp,lbdhdl,lbxgh,lbxtc,isSmoker,M1,F1,M2,F2,M3,F3,M4,F4,frs,wt,fpg), "/Users/bryankim/Documents/NBER/Framingham /Data/nhanes_1999_2000_imp_frs.dta")
...
write_dta(nhanes2001_2002 %>% select(seqn,riagendr,ridageyr,asbp,lbxtc,lbxgh,lbdhdl,isSmoker,M1,F1,M2,F2,M3,F3,M4,F4,frs,wt,fpg), "/Users/bryankim/Documents/NBER/Framingham /Data/nhanes_2001_2002_imp_frs.dta")
...
write_dta(nhanes2003_2004 %>% select(seqn,riagendr,ridageyr,asbp,lbxhdd,lbxgh,lbxtc,lbxgh,isSmoker,M1,F1,M2,F2,M3,F3,M4,F4,frs,wt,fpg), "/Users/bryankim/Documents/NBER/Framingham /Data/nhanes_2003_2004_imp_frs.dta")
...
write_dta(nhanes2005_2006 %>% select(seqn,riagendr,ridageyr,asbp,lbxgh,lbdhdd,lbxtc,isSmoker,M1,F1,M2,F2,M3,F3,M4,F4,frs,wt,fpg), "/Users/bryankim/Documents/NBER/Framingham /Data/nhanes_2005_2006_imp_frs.dta")
...
write_dta(nhanes2007_2008 %>% select(seqn,riagendr,ridageyr,asbp,lbdhdd,lbxtc,lbxgh,isSmoker,M1,F1,M2,F2,M3,F3,M4,F4,frs,wt,fpg), "/Users/bryankim/Documents/NBER/Framingham /Data/nhanes_2007_2008_imp_frs.dta")
...
write_dta(nhanes2009_2010 %>% select(seqn,riagendr,ridageyr,asbp,lbdhdd,lbxgh,lbxtc,isSmoker,M1,F1,M2,F2,M3,F3,M4,F4,frs,wt,fpg), "/Users/bryankim/Documents/NBER/Framingham /Data/nhanes_2009_2010_imp_frs.dta")
...
write_dta(nhanes2011_2012 %>% select(seqn,riagendr,ridageyr,asbp,lbdhdd,lbxgh,lbxtc,isSmoker,M1,F1,M2,F2,M3,F3,M4,F4,frs,wt,fpg), "/Users/bryankim/Documents/NBER/Framingham /Data/nhanes_2011_2012_imp_frs.dta")
...
write_dta(nhanes2013_2014 %>% select(seqn,riagendr,ridageyr,asbp,lbdhdd,lbxgh,lbxtc,isSmoker,M1,F1,M2,F2,M3,F3,M4,F4,frs,wt,fpg), "/Users/bryankim/Documents/NBER/Framingham /Data/nhanes_2013_2014_imp_frs.dta")
...
write_dta(nhanes2015_2016 %>% select(seqn,riagendr,ridageyr,asbp,lbdhdd,lbxgh,lbxtc,isSmoker,M1,F1,M2,F2,M3,F3,M4,F4,frs,wt,fpg), "/Users/bryankim/Documents/NBER/Framingham /Data/nhanes_2015_2016_imp_frs.dta")
...
write_dta(nhanes2017_2018 %>% select(seqn,riagendr,ridageyr,asbp,lbdhdd,lbxgh,lbxtc,isSmoker,M1,F1,M2,F2,M3,F3,M4,F4,frs,wt,fpg), "/Users/bryankim/Documents/NBER/Framingham /Data/nhanes_2017_2018_imp_frs.dta")

##########################################
##               NHANES II              ##
##########################################
write_dta(nhanesII %>% select(SEQN,SEX,AGEYR_AT_INT,asbp,lbdhdd,lbxtc,smoke_sts,fpg,M1,F1,M2,F2,M3,F3,M4,F4,frs,wt), "/Users/bryankim/Documents/NBER/Framingham /Data/nhanesII_imp_frs.dta")
...
write_dta(nhanesIIIP1 %>% select(SEQN,HSSEX,HSAGEIR,HDP,PEPMNK1R,TCP,fpg,smoke_sts,M1,F1,M2,F2,M3,F3,M4,F4,frs,wt), "/Users/bryankim/Documents/NBER/Framingham /Data/nhanesIIIP1_imp_frs.dta")
write_dta(nhanesIIIP2 %>% select(SEQN,HSSEX,HSAGEIR,HDP,PEPMNK1R,TCP,fpg,smoke_sts,M1,F1,M2,F2,M3,F3,M4,F4,frs,wt), "/Users/bryankim/Documents/NBER/Framingham /Data/nhanesIIIP2_imp_frs.dta")
