...
#################################
```{r}
temp_full=list(nhanes1999_2000,nhanes2001_2002,nhanes2003_2004,nhanes2005_2006,nhanes2007_2008,nhanes2009_2010,nhanes2011_2012,nhanes2013_2014,nhanes2015_2016,nhanes2017_2018)

## USING lapply to calculated the fitted values
temp = temp %>% lapply(function(x) {regress = lm(x$fpg ~ x$lbxgh,na.action=na.omit);mutate(x,imputed = fitted(regress))})
# TAKE OUT ALL ROWS WHERE FPG IS NA, because can't do mutate on those
nhanes1999_2000= nhanes1999_2000 %>% filter(is.na(nhanes1999_2000$riagendr & nhanes1999_2000$ridageyr & nhanes1999_2000$lbdhdl & nhanes1999_2000$lbxtc & nhanes1999_2000$asbp & nhanes1999_2000$isSmoker & nhanes1999_2000$fpg))
nhanes2001_2002= nhanes2001_2002 %>% filter(is.na(nhanes2001_2002$riagendr & nhanes2001_2002$ridageyr & nhanes2001_2002$lbdhdl & nhanes2001_2002$lbxtc & nhanes2001_2002$asbp & nhanes2001_2002$isSmoker & nhanes2001_2002$fpg))
nhanes2003_2004= nhanes2003_2004 %>% filter(is.na(nhanes2003_2004$riagendr & nhanes2003_2004$ridageyr & nhanes2003_2004$lbxhdd & nhanes2003_2004$lbxtc & nhanes2003_2004$asbp & nhanes2003_2004$isSmoker & nhanes2003_2004$fpg))
nhanes2005_2006= nhanes2005_2006 %>% filter(is.na(nhanes2005_2006$riagendr & nhanes2005_2006$ridageyr & nhanes2005_2006$lbdhdd & nhanes2005_2006$lbxtc & nhanes2005_2006$asbp & nhanes2005_2006$isSmoker & nhanes2005_2006$fpg))
nhanes2007_2008= nhanes2007_2008 %>% filter(is.na(nhanes2007_2008$riagendr & nhanes2007_2008$ridageyr & nhanes2007_2008$lbdhdd & nhanes2007_2008$lbxtc & nhanes2007_2008$asbp & nhanes2007_2008$isSmoker & nhanes2007_2008$fpg))
nhanes2009_2010= nhanes2009_2010 %>% filter(is.na(nhanes2009_2010$riagendr & nhanes2009_2010$ridageyr & nhanes2009_2010$lbdhdd & nhanes2009_2010$lbxtc & nhanes2009_2010$asbp & nhanes2009_2010$isSmoker & nhanes2009_2010$fpg))
nhanes2011_2012= nhanes2011_2012 %>% filter(is.na(nhanes2011_2012$riagendr & nhanes2011_2012$ridageyr & nhanes2011_2012$lbdhdd & nhanes2011_2012$lbxtc & nhanes2011_2012$asbp & nhanes2011_2012$isSmoker & nhanes2011_2012$fpg))
nhanes2013_2014= nhanes2013_2014 %>% filter(is.na(nhanes2013_2014$riagendr & nhanes2013_2014$ridageyr & nhanes2013_2014$lbdhdd & nhanes2013_2014$lbxtc & nhanes2013_2014$asbp & nhanes2013_2014$isSmoker & nhanes2013_2014$fpg))
nhanes2015_2016= nhanes2015_2016 %>% filter(is.na(nhanes2015_2016$riagendr & nhanes2015_2016$ridageyr & nhanes2015_2016$lbdhdd & nhanes2015_2016$lbxtc & nhanes2015_2016$asbp & nhanes2015_2016$isSmoker & nhanes2015_2016$fpg))
nhanes2017_2018= nhanes2017_2018%>% filter(is.na(nhanes2017_2018$riagendr & nhanes2017_2018$ridageyr & nhanes2017_2018$lbdhdd & nhanes2017_2018$lbxtc & nhanes2017_2018$asbp & nhanes2017_2018$isSmoker & nhanes2017_2018$fpg))
...
### COMPLETE CASES ###
######################
nhanes1999_2000= nhanes1999_2000[complete.cases(nhanes1999_2000[ , c("riagendr","ridageyr","lbdhdl","lbxtc","asbp","isSmoker","fpg")]),]
nhanes2001_2002= nhanes2001_2002[complete.cases(nhanes2001_2002[ , c("riagendr","ridageyr","lbdhdl","lbxtc","asbp","isSmoker","fpg")]),]
nhanes2003_2004= nhanes2003_2004[complete.cases(nhanes2003_2004[ , c("riagendr","ridageyr","lbxhdd","lbxtc","asbp","isSmoker","fpg")]),]
nhanes2005_2006= nhanes2005_2006[complete.cases(nhanes2005_2006[ , c("riagendr","ridageyr","lbdhdd","lbxtc","asbp","isSmoker","fpg")]),]
nhanes2007_2008= nhanes2007_2008[complete.cases(nhanes2007_2008[ , c("riagendr","ridageyr","lbdhdd","lbxtc","asbp","isSmoker","fpg")]),]
nhanes2009_2010= nhanes2009_2010[complete.cases(nhanes2009_2010[ , c("riagendr","ridageyr","lbdhdd","lbxtc","asbp","isSmoker","fpg")]),]
nhanes2011_2012= nhanes2011_2012[complete.cases(nhanes2011_2012[ , c("riagendr","ridageyr","lbdhdd","lbxtc","asbp","isSmoker","fpg")]),]
nhanes2013_2014= nhanes2013_2014[complete.cases(nhanes2013_2014[ , c("riagendr","ridageyr","lbdhdd","lbxtc","asbp","isSmoker","fpg")]),]
nhanes2015_2016= nhanes2015_2016[complete.cases(nhanes2015_2016[ , c("riagendr","ridageyr","lbdhdd","lbxtc","asbp","isSmoker","fpg")]),]
nhanes2017_2018= nhanes2017_2018[complete.cases(nhanes2017_2018[ , c("riagendr","ridageyr","lbdhdd","lbxtc","asbp","isSmoker","fpg")]),]
```
