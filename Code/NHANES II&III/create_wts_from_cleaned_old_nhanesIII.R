...
nhanesIIIP1=temp1[[1]]
w_M1_nhanesIIIP1 = nhanesIIIP1 %>% filter(M1 == 1) %>% select(WTPFQX1) %>% sum
w_F1_nhanesIIIP1 = nhanesIIIP1 %>% filter(F1 == 1) %>% select(WTPFQX1) %>% sum
w_M2_nhanesIIIP1 = nhanesIIIP1 %>% filter(M2 == 1) %>% select(WTPFQX1) %>% sum
w_F2_nhanesIIIP1 = nhanesIIIP1 %>% filter(F2 == 1) %>% select(WTPFQX1) %>% sum
w_M3_nhanesIIIP1 = nhanesIIIP1 %>% filter(M3 == 1) %>% select(WTPFQX1) %>% sum
w_F3_nhanesIIIP1 = nhanesIIIP1 %>% filter(F3 == 1) %>% select(WTPFQX1) %>% sum
...
nhanesIIIP2=temp[[1]]
w_M1_nhanesIIIP2 = nhanesIIIP2 %>% filter(M1 == 1) %>% select(WTPFQX2) %>% sum
w_F1_nhanesIIIP2 = nhanesIIIP2 %>% filter(F1 == 1) %>% select(WTPFQX2) %>% sum
w_M2_nhanesIIIP2 = nhanesIIIP2 %>% filter(M2 == 1) %>% select(WTPFQX2) %>% sum
w_F2_nhanesIIIP2 = nhanesIIIP2 %>% filter(F2 == 1) %>% select(WTPFQX2) %>% sum
w_M3_nhanesIIIP2 = nhanesIIIP2 %>% filter(M3 == 1) %>% select(WTPFQX2) %>% sum
w_F3_nhanesIIIP2 = nhanesIIIP2 %>% filter(F3 == 1) %>% select(WTPFQX2) %>% sum
temp=list(nhanesIIIP2)
