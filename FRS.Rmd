...
w_M1_nhanesIIIP2 = temp %>% filter(M1 == 1) %>% select(WTPFHX2) %>% sum
w_F1_nhanesIIIP2= temp %>% filter(F1 == 1) %>% select(WTPFHX2) %>% sum
w_M2_nhanesIIIP2= temp %>% filter(M2 == 1) %>% select(WTPFHX2) %>% sum
w_F2_nhanesIIIP2= temp %>% filter(F2 == 1) %>% select(WTPFHX2) %>% sum
w_M3_nhanesIIIP2= temp %>% filter(M3 == 1) %>% select(WTPFHX2) %>% sum
w_F3_nhanesIIIP2= temp %>% filter(F3 == 1) %>% select(WTPFHX2) %>% sum
w_M4_nhanesIIIP2= temp %>% filter(M4 == 1) %>% select(WTPFHX2) %>% sum
w_F4_nhanesIIIP2= temp %>% filter(F4 == 1) %>% select(WTPFHX2) %>% sum



temp = mutate(temp,wt = case_when(M1 == 1 ~ eval(WTPFHX2)*(eval(w_M1_1999_2000)/(eval(w_M1_nhanesIIIP2))),
                                            F1 == 1 ~ eval(WTPFHX2)*(eval(w_F1_1999_2000)/(eval(w_F1_nhanesIIIP2))),
                                            M2 == 1 ~ eval(WTPFHX2)*(eval(w_M2_1999_2000)/(eval(w_M2_nhanesIIIP2))),
                                            F2 == 1 ~ eval(WTPFHX2)*(eval(w_F2_1999_2000)/(eval(w_F2_nhanesIIIP2))),
                                            M3 == 1 ~ eval(WTPFHX2)*(eval(w_M3_1999_2000)/(eval(w_M3_nhanesIIIP2))),
                                            F3 == 1 ~ eval(WTPFHX2)*(eval(w_F3_1999_2000)/(eval(w_F3_nhanesIIIP2))),
                                            M4 == 1 ~ eval(WTPFHX2)*(eval(w_M4_1999_2000)/(eval(w_M4_nhanesIIIP2))),
                                            F4 == 1 ~ eval(WTPFHX2)*(eval(w_F4_1999_2000)/(eval(w_F4_nhanesIIIP2))),
                                            TRUE ~ NA_real_))
...
weighted.mean(nhanesIIIP1$HSSEX,nhanesIIIP1$WTPFHX1)
weighted.mean(nhanesIIIP1$HDP,nhanesIIIP1$WTPFHX1)
weighted.mean(nhanesIIIP1$TCP,nhanesIIIP1$WTPFHX1)
weighted.mean(nhanesIIIP1$PEPMNK1R,nhanesIIIP1$WTPFHX1)
weighted.mean(nhanesIIIP1$smoke_sts,nhanesIIIP1$WTPFHX1)
nhanesIIIP1$isDiabetic = ifelse()
weighted.mean(nhanesIIIP1$GHP,nhanesIIIP1$WTPFHX1)

# 2009-2010
weighted.mean(nhanes2009_2010$HSAGEIR,nhanes2009_2010$WTPFHX1)


# 2017-2018
weighted.mean(nhanesIIIP1$HSAGEIR,nhanesIIIP1$WTPFHX1)
