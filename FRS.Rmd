...
write_dta(nhanesIII, "/homes/nber/kimcwa/Documents/casedeaton/FRS/nhanesIII_frs.dta")
```
...
temp[[1]] = mutate(temp[[1]],wt = case_when(M1 == 1 ~ eval(wtint2yr)*(eval(w_M1_1999_2000)/(eval(w_M1_1999_2000))),
                                            F1 == 1 ~ eval(wtint2yr)*(eval(w_F1_1999_2000)/(eval(w_F1_1999_2000))),
                                            M2 == 1 ~ eval(wtint2yr)*(eval(w_M2_1999_2000)/(eval(w_M2_1999_2000))),
                                            F2 == 1 ~ eval(wtint2yr)*(eval(w_F2_1999_2000)/(eval(w_F2_1999_2000))),
                                            M3 == 1 ~ eval(wtint2yr)*(eval(w_M3_1999_2000)/(eval(w_M3_1999_2000))),
                                            F3 == 1 ~ eval(wtint2yr)*(eval(w_F3_1999_2000)/(eval(w_F3_1999_2000))),
                                            M4 == 1 ~ eval(wtint2yr)*(eval(w_M4_1999_2000)/(eval(w_M4_1999_2000))),
                                            F4 == 1 ~ eval(wtint2yr)*(eval(w_F4_1999_2000)/(eval(w_F4_1999_2000))),
                                            TRUE ~ NA_real_))
...
for (sex in c("M","F")) {
    for (cat in c(1,2,3,4)) {
      assign(paste("w_",sex,cat,"_",year,sep = ""),temp %>% filter(eval(parse(text = paste(sex,cat,sep=""))) == 1) %>% select(WTPFHX6) %>% sum)
  }
}
w_M1_nhanesIII = temp %>% filter(M1 == 1) %>% select(WTPFHX6) %>% sum
w_F1_nhanesIII= temp %>% filter(F1 == 1) %>% select(WTPFHX6) %>% sum
w_M2_nhanesIII= temp %>% filter(M2 == 1) %>% select(WTPFHX6) %>% sum
w_F2_nhanesIII= temp %>% filter(F2 == 1) %>% select(WTPFHX6) %>% sum
w_M3_nhanesIII= temp %>% filter(M3 == 1) %>% select(WTPFHX6) %>% sum
w_F3_nhanesIII= temp %>% filter(F3 == 1) %>% select(WTPFHX6) %>% sum
w_M4_nhanesIII= temp %>% filter(M4 == 1) %>% select(WTPFHX6) %>% sum
w_F4_nhanesIII= temp %>% filter(F4 == 1) %>% select(WTPFHX6) %>% sum



temp = mutate(temp,wt = case_when(M1 == 1 ~ eval(WTPFHX6)*(eval(w_M1_1999_2000)/(eval(w_M1_nhanesIII))),
                                            F1 == 1 ~ eval(WTPFHX6)*(eval(w_F1_1999_2000)/(eval(w_F1_nhanesIII))),
                                            M2 == 1 ~ eval(WTPFHX6)*(eval(w_M2_1999_2000)/(eval(w_M2_nhanesIII))),
                                            F2 == 1 ~ eval(WTPFHX6)*(eval(w_F2_1999_2000)/(eval(w_F2_nhanesIII))),
                                            M3 == 1 ~ eval(WTPFHX6)*(eval(w_M3_1999_2000)/(eval(w_M3_nhanesIII))),
                                            F3 == 1 ~ eval(WTPFHX6)*(eval(w_F3_1999_2000)/(eval(w_F3_nhanesIII))),
                                            M4 == 1 ~ eval(WTPFHX6)*(eval(w_M4_1999_2000)/(eval(w_M4_nhanesIII))),
                                            F4 == 1 ~ eval(WTPFHX6)*(eval(w_F4_1999_2000)/(eval(w_F4_nhanesIII))),
                                            TRUE ~ NA_real_))
...
############################################################
#FOR NHANES III
nhanesIII_file = list.files("/homes/nber/kimcwa/Documents/casedeaton/FRS",pattern = "III_frs.dta",full.names = TRUE)
df_listIII = lapply(nhanesIII_file,read_dta)

weighted.mean(nhanesIII$frs,nhanesIII$WTPFHX6)
##### BY EDUCATION #####
# <HS 
# <HS 
lapply(df_listIII, function(x) {temp = filter(x,x$HFA8R <= 11);print(weighted.mean(temp$frs,temp$WTPFHX6))})

# HS
lapply(df_listIII, function(x) {temp = filter(x,x$HFA8R == 12);print(weighted.mean(temp$frs,temp$WTPFHX6))})

# Some College
lapply(df_listIII, function(x) {temp = filter(x,x$HFA8R > 12 & x$HFA8R < 16);print(weighted.mean(temp$frs,temp$WTPFHX6))})

# College Grad
lapply(df_listIII, function(x) {temp = filter(x,x$HFA8R >= 16);print(weighted.mean(temp$frs,temp$WTPFHX6))})

##### BY AGE #####
# 45-54
lapply(df_listIII, function(x) {temp = filter(x,x$HSAGEIR >=45 & x$HSAGEIR <=54);print(weighted.mean(temp$frs,temp$WTPFHX6))})
# 55-64
lapply(df_listIII, function(x) {temp = filter(x,x$HSAGEIR >=55 & x$HSAGEIR <=64);print(weighted.mean(temp$frs,temp$WTPFHX6))})
# 65-74
lapply(df_listIII, function(x) {temp = filter(x,x$HSAGEIR >=65 & x$HSAGEIR <=74);print(weighted.mean(temp$frs,temp$WTPFHX6))})
# 75+
lapply(df_listIII, function(x) {temp = filter(x,x$HSAGEIR >=75);print(weighted.mean(temp$frs,temp$WTPFHX6))})
# 85+
