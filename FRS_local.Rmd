...
############################################################
 # CONTINUOUS
############################################################
nhanes1999_2000$HDL = nhanes1999_2000$lbdhdl
nhanes2001_2002$HDL = nhanes2001_2002$lbdhdl
nhanes2003_2004$HDL = nhanes2003_2004$lbxhdd
nhanes2005_2006$HDL = nhanes2005_2006$lbdhdd
nhanes2007_2008$HDL = nhanes2007_2008$lbdhdd
nhanes2009_2010$HDL = nhanes2009_2010$lbdhdd
nhanes2011_2012$HDL = nhanes2011_2012$lbdhdd
nhanes2013_2014$HDL = nhanes2013_2014$lbdhdd
nhanes2015_2016$HDL = nhanes2015_2016$lbdhdd
nhanes2017_2018$HDL = nhanes2017_2018$lbdhdd

nhanes1999_2000$asbp = nhanes1999_2000$bpxsar
nhanes2001_2002$asbp = nhanes2001_2002$bpxsar
nhanes2003_2004$asbp = nhanes2003_2004$bpxsar
...
lapply(temp, function(x) {x=filter(x,dmdeduc2 == 3);x$isDiabetic = ifelse(x$lbxgh < 6.3,1,0);print(weighted.mean(x$isDiabetic,x$wt))})
...
lapply(temp, function(x) {x=filter(x,dmdeduc2 == 4);x$isDiabetic = ifelse(x$lbxgh < 6.4,1,0);print(weighted.mean(x$isDiabetic,x$wt))})
